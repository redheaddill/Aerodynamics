...
close all
    ...
    VLData.Element(1).X.Root = xw-xCG;                   % Lifting Element x Coordinate @ Quarter Chord
    VLData.Element(1).Y.Root = 0;                   % Lifting Element y Coordinate @ Quarter Chord
    VLData.Element(1).Z.Root = zw-zCG;                   % Lifting Element z Coordinate @ Quarter Chord
    ...
    VLData.Element(2).X.Root = xw-xCG;                   % Lifting Element x Coordinate @ Quarter Chord
    VLData.Element(2).Y.Root = Vanguard.Wing.Yehudi/2;                   % Lifting Element y Coordinate @ Quarter Chord
    VLData.Element(2).Z.Root = zw-zCG;                   % Lifting Element z Coordinate @ Quarter Chord
    ...
    VLData.Element(3).X.Root = xw-xCG;
    VLData.Element(3).Y.Root = Vanguard.Wing.Yehudi;
    VLData.Element(3).Z.Root = zw-zCG;
    ...
    VLData.Element(4).X.Root = xw-xCG;
    VLData.Element(4).Y.Root = taper1;
    VLData.Element(4).Z.Root = zw-zCG;
    ...
    VLData.Element(5).X.Root = xw-xCG;
    VLData.Element(5).Y.Root = taper2;
    VLData.Element(5).Z.Root = zw-zCG;
    ...
    VLData.Element(6).X.Root = xw-xCG;
    VLData.Element(6).Y.Root = Vanguard.Wing.Aileron;
    VLData.Element(6).Z.Root = zw-zCG;
...
%     VLData.Element(7).X.Root = xES1-xCG;
%     VLData.Element(7).Y.Root = 17.75;
%     VLData.Element(7).Z.Root = zES1-zCG;
...
%     VLData.Element(8).X.Root = xES2-xCG;
%     VLData.Element(8).Y.Root = 20.5;
%     VLData.Element(8).Z.Root = zES2-zCG;
...
%     VLData.Element(9).X.Root = xES3-xCG;
%     VLData.Element(9).Y.Root = 39.75;
%     VLData.Element(9).Z.Root = zES3-zCG;
...
%     VLData.Element(10).X.Root = xES4-xCG;
%     VLData.Element(10).Y.Root = 42.5;
%     VLData.Element(10).Z.Root = zES4-zCG;
...
%     VLData.Element(11).X.Root = xh-xCG;
%     VLData.Element(11).Y.Root = 4;
%     VLData.Element(11).Z.Root = zh-zCG;
...
%     VLData.Element(12).X.Root = xv-xCG;
%     VLData.Element(12).Y.Root = 0;
%     VLData.Element(12).Z.Root = zv-zCG;
...
%     VLData.Element(13).X.Root = xe-xCG;
%     VLData.Element(13).Y.Root = 7.9;
%     VLData.Element(13).Z.Root = ze-zCG;
...
%     VLData.Element(14).X.Root = xr-xCG;
%     VLData.Element(14).Y.Root = 0;
%     VLData.Element(14).Z.Root = zr-zCG;
...
%     VLData.Element(14).wakelocation = 1;
    ...
    FCData.Mach  = 0.4;    % Freestream Mach number (Cruise 375 kts)

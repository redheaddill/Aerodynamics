...
for i = 1:length(mach)
    ...
    output(i,:) = [M CL Cm CD CL_M Cm_M CD_M CL_a Cm_a CD_a CL_adot Cm_adot CD_adot CL_q Cm_q CD_q CL_de Cm_de CD_de CY_B Cl_B Cn_B CY_p Cl_p Cn_p CY_r Cl_r Cn_r CY_dr Cl_dr Cn_dr CY_da Cl_da Cn_da];

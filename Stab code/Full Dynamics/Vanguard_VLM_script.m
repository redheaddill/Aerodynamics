...
M = 0.4; % Free stream Mach number
a = 0; % Angle of attack (deg)
B = 0.1; % Sideslip angle (deg)
p = 0; % Nondimensional roll rate (rad/s)
q = 0; % Nondimensional pitch rate (rad/s)
r = 0; % Nondimensional yaw rate (rad/s)
de = 5; % Elevator deflection (deg)
dr = 10; % Rudder deflection (deg)
da = 10; % Aileron deflection (deg)
xCG = 41.75; % ft
zCG = 12.41; % ft
